...
class OrderPage(BasePage):
    ...
    def fill_first_form(self, data):
        ...
        metro_option = (By.XPATH, f"//div[text()='{data['metro']}']")
        self.wait_and_click_dynamic(metro_option)
    ...
    def click_next_button(self):
        ...
        self.wait_element_visible(OrderFormLocators.date_input_field)
    ...
    def fill_second_form(self, data):
        ...
        self.wait_element_clickable(data["rental_period_locator"])
        self.click_element(data["rental_period_locator"])
        self.click_element(data["color_locator"])
